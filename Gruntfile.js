...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Distillation.st', // list all sources in dependency order
                    'src/Distillation-UI.st',
                    'src/Distillation-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-distillation',
